...
- 30-year mean PCWD of 21st century lies outside all references (red point above red line, grey band, and grey line).

## 100-year extreme value

```{r}
# Function: fit Gumbel with extRemes and estimate T-year return level
fit_gumbel_return <- function(x, T = 100) {
  # Fit Gumbel (GEV with shape = 0)
  fit <- extRemes::fevd(x, type = "Gumbel")
