...
corrected_full <- readRDS("~/cwd_global/data/regionalResults_ModESim_bc.RData")
...
ggsave(
  filename = "~/cwd_global/manuscript/scatter_legend.pdf",
 # plot     = combined2all,
  device   = cairo_pdf,    # better text rendering
  width    = 10,           # in inches
  height   =8,            # in inches
...
ggsave(
  filename = "~/cwd_global/manuscript/Scatter_plots_tvalue_legend.pdf",
  device   = cairo_pdf,    # better text rendering
  width    = 17,           # in inches
  height   = 13,            # in inches
  units    = "in",
