...
```{r}
df <- readRDS("/Users/phelpap/Library/CloudStorage/OneDrive-Personal/Dokumente/Bern/Master thesis/R/cwd/data/df_us-ton.rds") |> 
...
fLUE_PDSI <- fLUE_PDSI + theme(plot.margin = margin(t = 0, r = 0, b = 0, l = 5))
...
ggsave(
  filename = here::here("figures/combined_fLUE.pdf"),
  plot     = combined_fLUE,
  device   = cairo_pdf,    # better text rendering
  width    = 9,           # in inches
  height   = 7,            # in inches
